...
int main( int argc, char** argv )
{
    ...
    //Mat img_ori = imread( argv[2], IMREAD_COLOR );
    ...
    std::cout << "point in pano image is " << std::endl;
    std::cout << "(" << scene_corners[0].x << "," << scene_corners[0].y  << ") " << std::endl;
    std::cout << "(" << scene_corners[2].x << "," << scene_corners[2].y  << ") " << std::endl;


   // Mat img_out = img_scene(Rect(scene_corners[0].x,scene_corners[0].y,
   //         abs(scene_corners[2].x - scene_corners[0].x),abs(scene_corners[2].y - scene_corners[0].y)));
    ...
    //imwrite ("/home/img_out.jpg",img_out);
